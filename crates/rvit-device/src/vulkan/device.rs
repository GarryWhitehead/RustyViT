...
use rvit_vk_backend::Driver;
use rvit_vk_backend::public_types::{DeviceType, StorageBuffer, UniformBuffer};
use rvit_vk_backend::vk_shader::ShaderProgram;
use std::fmt::Debug;
use std::{cell::RefCell, collections::HashMap, error::Error, ops::Deref, sync::Arc};

#[derive(Clone)]
pub struct Vulkan {
    pub driver: Arc<RefCell<Driver>>,
    pub modules: HashMap<String, ShaderProgram>,
}
